...
def main():
    ...
    df_fans_order = df_fans_order.merge(df_order_campaign_hx, on=['dept_name', 'wechat_number', 'first_time'],
                                        how='left')
    df_fans_order = df_fans_order.merge(df_order_fg, on=['dept_name', 'wechat_number', 'first_time'], how='left')
    df_fans_order = df_fans_order.merge(df_order_campaign_fg, on=['dept_name', 'wechat_number', 'first_time'],
                                        how='left')
    df_fans_order = df_fans_order.fillna(0)
