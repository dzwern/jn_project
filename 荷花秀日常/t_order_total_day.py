...
def main():
    ...
    df_order_total = df_order_total.merge(df_order_activity, on=['dept_name', 'wechat_number', 'create_time'],
                                          how='left')
    # 总单价
    df_order_total['member_price_total'] = df_order_total['order_amount_total'] / df_order_total['order_member_total']
    # 活动单价
    df_order_total['member_price_campaign'] = df_order_total['order_amount_campaign'] / df_order_total['order_member_campaign']
    # 日常单价
    df_order_total['member_price_day'] = df_order_total['order_amount_day'] / df_order_total['order_member_day']
